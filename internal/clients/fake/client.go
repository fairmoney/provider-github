...
type MockRepositoriesClient struct {
	...
	MockGetHook            func(ctx context.Context, owner, repo string, id int64) (*github.Hook, *github.Response, error)
...
func (m *MockRepositoriesClient) GetHook(ctx context.Context, owner, repo string, id int64) (*github.Hook, *github.Response, error) {
	return m.MockGetHook(ctx, owner, repo, id)
}
